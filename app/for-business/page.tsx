  ...
  return (
    <main className="min-h-screen bg-dark-bg">
      ...
      <section className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
        {/* Background gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-purple-900/20 via-dark-bg to-blue-900/20"></div>
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <h1 className="text-5xl md:text-7xl font-black mb-8 tracking-tight">
            ...
            <br />
            <span className="gradient-text">Even when you're not there.</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-dark-muted mb-12 max-w-4xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-8">
            <a 
              ...
              className="bg-gradient-to-r from-purple-accent to-blue-accent text-white px-8 py-4 rounded-xl font-semibold text-lg hover:scale-105 transition-all duration-300 glow-effect flex items-center gap-3"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-dark-card p-6 rounded-xl border border-gray-800">
                ...
                <p className="text-dark-muted leading-relaxed">{pain.description}</p>
              </div>
            ))}
          </div>
        </div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-start gap-4">
                    ...
                    <span className="text-dark-text">{task}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-dark-card p-8 rounded-xl border border-gray-800">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <ClockIcon className="w-6 h-6 text-blue-accent" />
                  <span className="text-dark-text"><strong>40+ hours</strong> back in your week</span>
                </div>
                <div className="flex items-center gap-3">
                  <CurrencyDollarIcon className="w-6 h-6 text-green-400" />
                  <span className="text-dark-text"><strong>Zero missed</strong> follow-ups or opportunities</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckIcon className="w-6 h-6 text-purple-accent" />
                  <span className="text-dark-text">Business runs while you <strong>actually take breaks</strong></span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="text-center">
                <div className="w-16 h-16 bg-gradient-to-r from-purple-accent to-blue-accent rounded-full flex items-center justify-center text-2xl font-bold text-white mx-auto mb-6">
                  {step.step}
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-red-900/20 border border-red-500/30 p-8 rounded-xl">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  <span className="text-dark-muted">Salary (part-time)</span>
                  <span className="text-white font-semibold">$2,500/month</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-dark-muted">Benefits & taxes</span>
                  <span className="text-white font-semibold">$500/month</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-dark-muted">Training time</span>
                  <span className="text-white font-semibold">20+ hours</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-dark-muted">Mistakes & sick days</span>
            ...
            <div className="bg-green-900/20 border border-green-500/30 p-8 rounded-xl">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  <span className="text-dark-muted">Setup & configuration</span>
                  <span className="text-white font-semibold">One-time</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-dark-muted">Monthly service</span>
                ...
                <div className="flex justify-between">
                  <span className="text-dark-muted">Sick days & mistakes</span>
          ...
          <div className="text-center mt-12">
            <div className="bg-dark-card p-6 rounded-xl border border-gray-800 max-w-2xl mx-auto">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">
            ...
            <br />
            <span className="gradient-text">Start working <em>on</em> it.</span>
          </h2>
          ...
          <a 
            ...
            className="bg-gradient-to-r from-purple-accent to-blue-accent text-white px-12 py-6 rounded-xl font-semibold text-xl hover:scale-105 transition-all duration-300 glow-effect inline-flex items-center gap-4"
          >
            Book Your Free Consultation
            <ChevronRightIcon className="w-6 h-6" />
          </a>
          
          <p className="text-sm text-dark-muted mt-8">
